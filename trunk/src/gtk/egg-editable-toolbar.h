 ...
 *
 *  $Id: egg-editable-toolbar.h 774 2006-05-25 06:25:32Z nshmyrev $
 */
...
GtkWidget *egg_editable_toolbar_new (GtkUIManager * manager, const char *visibility_path);
GtkWidget *egg_editable_toolbar_new_with_model (GtkUIManager * manager, EggToolbarsModel * model, const char *visibility_path);
...
void egg_editable_toolbar_set_fixed (EggEditableToolbar * etoolbar, GtkToolbar * fixed_toolbar);
