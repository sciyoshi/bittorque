...
static void
move_item_cb (GtkAction          *action G_GNUC_UNUSED,
              EggEditableToolbar *etoolbar)
{
...
static void
remove_item_cb (GtkAction          *action G_GNUC_UNUSED,
                EggEditableToolbar *etoolbar)
{
  GtkWidget *toolitem = gtk_widget_get_ancestor (egg_editable_toolbar_get_selected (etoolbar), GTK_TYPE_TOOL_ITEM);
  int pos, toolbar_pos;
...
static void
remove_toolbar_cb (GtkAction          *action G_GNUC_UNUSED,
		   EggEditableToolbar *etoolbar)
{
...
static void
popup_context_deactivate (GtkMenuShell *menu G_GNUC_UNUSED,
			  EggEditableToolbar *etoolbar)
{
...
static void
action_sensitive_cb (GtkAction   *action G_GNUC_UNUSED, 
...
static gboolean
style_set_cb (GtkWidget *widget G_GNUC_UNUSED,
              GtkStyle *previous_style G_GNUC_UNUSED,
              GtkImage *image)
{
